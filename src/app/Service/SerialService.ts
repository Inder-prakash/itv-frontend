...
export class SerialService {
  ...
  uploadEpisodeByExcel() {
    return this.appconfig.geturl() + this.appconfig.uploadEpisodeByExcel;
  }
  downloadEpisodeInExcel() {
    return this.appconfig.geturl() + this.appconfig.downloadEpisodeInExcel;
  }
}
